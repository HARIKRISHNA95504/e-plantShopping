...
import './AboutUs.css';
// import plantLogo from './assets/plant_logo.jpg'
...
function AboutUs() {
  return (
    <div className="about-us-container">
      ...
      {/* <p className="plant_logo_left"><img src={plantLogo} height='50px' width='50px' alt="" /></p> */}
      <p className="about-us-content">
      ...
      {/* <p className="plant_logo_right"><img src={plantLogo} height='50px' width='50px' alt="" /></p> */}
